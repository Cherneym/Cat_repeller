...
trigger_line18 = chip.get_line(trigger)
echo_line24 = chip.get_line(echo)
...
trigger_line18.request(consumer="LED", type=gpiod.LINE_REQ_DIR_OUT)
echo_line24.request(consumer="LED", type=gpiod.LINE_REQ_DIR_IN)
#############################################################################################
...
class Yolov8TFLite:
    ...
    def postprocess(self, input_image, output):
        ...
        return input_image
##############################attempt to try on rely if a human is detected################################################
#        while True:
#            if score > 0.25 and class_id[0]:
#               led_line4.set_value(1)	#on
###########################################################################################################################
